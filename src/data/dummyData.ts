...
export const generateDummyResult = (
  ...
  const heatmapSpecies = [
    ...
    { name: "Rebhuhn", base: 0.9 },
    { name: "Grasfrosch", base: 0.65 },
    { name: "Wachtel", base: 0.72 },
  ...
  const species = [
      ...
      },
      {
        ...
        group: "Voegel",
        groupIcon: "Vg",
        legalLabels: ["FFH-Vorschlag"],
        evidenceScore: 90,
        confidence: "hoch",
        dataStatus: "Modellhinweis",
        effects: ["Habitatverlust", "Stoerung"],
        evidenceLayers: { observations: false, habitatProxy: true, sdm: true },
        reasons: ["Regulatorische Einheit: FFH-Vorschlag"],
        sdmValue: 0.9,
      },
      {
        id: "3",
        ...
        group: "Amphibien",
        groupIcon: "Am",
        legalLabels: ["Rote Liste"],
        evidenceScore: 65,
        confidence: "mittel",
        dataStatus: "Modellhinweis",
        effects: ["Habitatverlust", "Barriere"],
        evidenceLayers: { observations: false, habitatProxy: true, sdm: true },
        reasons: ["Regulatorische Einheit: Rote Liste"],
        sdmValue: 0.65,
      },
      {
        id: "4",
        ...
        confidence: "hoch",
        dataStatus: "Modellhinweis",
        effects: ["Habitatverlust", "Brutplatzstoerung"],
        evidenceLayers: { observations: false, habitatProxy: true, sdm: true },
        reasons: ["Regulatorische Einheit: Rote Liste"],
        sdmValue: 0.72,
      },
